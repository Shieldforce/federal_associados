...
class VehicleJob implements ShouldQueue
{
    ...
    public function handle()
    {
        $results = FipeCurlService::run(
            ...
            EndpointsFipeEnum::endpointResolve(EndpointsFipeEnum::vehicle->name),
            $this->result
        );
        ...
        FipeVehicle::updateOrCreate(
            ...
            [
                ...
                "ValorReal"              => $this->transformApiValueInDecimal($this->result["vehicle"]['Valor']),
    ...
    public function transformApiValueInDecimal($value)
    {
